...
public class MainActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.visneweb.techbay.tracker.R.layout.activity_main);
        adapter = new ScannerAdapter(this);
        setListAdapter(adapter);
        scan = findViewById(com.visneweb.techbay.tracker.R.id.scan);
